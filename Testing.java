...
public class Testing {
    ...
    @Test
    public void synchronizeEmptyTest() throws InterruptedException{
        commitAll(repo2, new String[]{"Nike", "Johnny"});
        repo1.synchronize(repo2);
        assertEquals(0, repo2.getRepoSize());
        assertEquals(2, repo1.getRepoSize());
        testHistory(repo1, 2, new String[]{"Nike", "Johnny"});
    }

    @Test
    public void synchronizeFrontTest() throws InterruptedException{
        commitAll(repo1, new String[]{"OldCommit"});
        commitAll(repo2, new String[]{"NewCommit"});
        repo1.synchronize(repo2);
        testHistory(repo1, 2, new String[]{"OldCommit", "NewCommit"});
    }

    @Test
    public void synchronizeMiddleTest() throws InterruptedException{
        commitAll(repo1, new String[]{"Commit1", "Commit3"});
        commitAll(repo2, new String[]{"Commit2"});
        repo1.synchronize(repo2);
        testHistory(repo1, 3, new String[]{"Commit1", "Commit3", "Commit2"});
    }

    @Test
    public void synchronizeEndTest() throws InterruptedException{
        commitAll(repo1, new String[]{"Commit2", "Commit3"});
        commitAll(repo2, new String[]{"Commit1"});
        repo1.synchronize(repo2);
        testHistory(repo1, 3, new String[]{"Commit2", "Commit3", "Commit1"});
